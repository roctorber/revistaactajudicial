<?php return array (
  ...
  'plugins.generic.pln.issueId' => 'Issue Id',
  ...
  'plugins.generic.pln.status.status' => 'Status',
  ...
  'plugins.generic.pln.displayedstatus.pending' => 'Pending',
  'plugins.generic.pln.displayedstatus.pending.description' => 'The process of the deposit has not yet started',
  'plugins.generic.pln.displayedstatus.inprogress' => 'In Progress',
  'plugins.generic.pln.displayedstatus.inprogress.description' => 'The deposit process is in progress',
  'plugins.generic.pln.displayedstatus.completed' => 'Completed',
  'plugins.generic.pln.displayedstatus.completed.description' => 'The deposit process is completed',
  'plugins.generic.pln.displayedstatus.error' => 'Error',
  'plugins.generic.pln.displayedstatus.error.description' => 'There has been an error regarding the deposit process',
  'plugins.generic.pln.status.warning' => 'It might take several days for a deposit to be fully processed.',
  'plugins.generic.pln.status.latestupdate' => 'Latest Update',
  'plugins.generic.pln.status.description.title' => 'Status Description',
);